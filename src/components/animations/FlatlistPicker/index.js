...
const ConnectWithText = React.memo(() => {
  ...
  return (
    <View
      style={{
        position: "absolute",
        top: screenHeight / 2 - ITEM_HEIGHT * 2,
        width: width * 0.7,
    ...
    return (
      <Animated.FlatList
        ...
        contentContainerStyle={{
          paddingTop: showText ? 0 : screenHeight / 2 - ITEM_HEIGHT / 2,
          paddingBottom: showText ? 0 : screenHeight / 2 - ITEM_HEIGHT / 2,
